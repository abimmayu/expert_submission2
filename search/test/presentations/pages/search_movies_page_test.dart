...
void main() {
  ...
  testWidgets('Should display circular progress indicator when loading',
    ...
    when(() => fakeMovieSearchBloc.state).thenReturn(SearchMoviesLoading());

    final circularProgressIndicatorFinder =
        find.byType(CircularProgressIndicator);

    await tester.pumpWidget(_createTestableWidget(const SearchPage()));
    await tester.pump();
  ...
  testWidgets(
    ...
    when(() => fakeMovieSearchBloc.state)
        .thenReturn(SearchMoviesLoaded(testMovieList));
    await tester.pumpWidget(_createTestableWidget(const SearchPage()));
    await tester.pump();
