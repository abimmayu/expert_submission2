...
void main() {
  ...
  setUp(() {
    ...
    movieSearchBloc = SearchMoviesBloc(searchMovies: mockSearchMovie);
  });
  ...
  group('Search movie with bloc', () {
    ...
    blocTest<SearchMoviesBloc, SearchMoviesState>(
      'Should emit [Loading, Loaded] when search Movie data is successfully',
      build: () {
      ...
      expect: () => [
        SearchMoviesLoading(),
        SearchMoviesLoaded(movieListTest),
      ],
      verify: (bloc) {
