...
import 'package:muse/common/exception.dart';
import 'package:muse/data/datasources/tv_remote_datasource.dart';
import 'package:muse/data/models/tv_detail.dart';
import 'package:muse/data/models/tv_response.dart';
...
void main() {
  ...
  group('get Top Rated Tv', () {
    final tMovieList = TvResponse.fromJson(
            json.decode(readJson('dummy_data/tv_top_rate.json')))
        .tvList;
    ...
    test('should return list of Tv when response code is 200 ', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/top_rated?$API_KEY')))
          .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/tv_top_rate.json'), 200));
      // act
